        ...
        <div className="rounded-[2rem] bg-[#0d2f57] p-8 text-white shadow-2xl shadow-blue-950/20 sm:p-10">
          ...
          <div className="mt-8 flex flex-col gap-4 sm:flex-row">
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="rounded-full bg-[#d62828] px-7 py-4 text-center font-bold text-white shadow-lg shadow-red-950/20 transition hover:bg-[#b91c1c]"
            >
              WhatsApp +91 84607 97050
            </a>
            <a
              href="tel:+918460797050"
              className="rounded-full border border-white/30 px-7 py-4 text-center font-bold text-white transition hover:bg-white hover:text-[#0d2f57]"
            >
              Call Now
            </a>
          </div>
        ...
        <div className="soft-card rounded-[2rem] p-8 sm:p-10">
          ...
          <dl className="mt-7 space-y-6">
            ...
            <div>
              ...
              <dd className="mt-1 text-slate-600">+91 84607 97050</dd>
            </div>
            <div>
